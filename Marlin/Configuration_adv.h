...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLERFAN_SPEED_ACTIVE     78 // (0-255) Active speed, used when any motor is enabled
...
#define HOMING_BUMP_MM      { 5, 5, 0 }       // (linear=mm, rotational=°) Backoff from endstops after first bump
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 15*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
>>>>>>> d3def6e1d8 (Working changes for Microswiss NG Revo and, BTT Mini SKR E3 V3 and BTT TFT35 E3 v3.0.1)
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  0.002  // (steps or mm) Steps or millimeter distance for each Z babystep
