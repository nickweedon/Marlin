...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  42.4127,  42.4127 }
    #define DEFAULT_Ki_LIST {   6.3875,   6.3875 }
    #define DEFAULT_Kd_LIST { 70.4051, 70.4051 }
  #else
    #define DEFAULT_Kp 20.0256
    #define DEFAULT_Ki 3.8511
    #define DEFAULT_Kd 26.0333
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 234.7238
  #define DEFAULT_bedKi 41.3246
  #define DEFAULT_bedKd 888.8209
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 439 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  // Set the number of grid points per dimension. Grid for Auto Bed Leveling. Y is currently set to the same as X. ex. 7 x 7, 5 x 5 etc.
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 161  // (mm) X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT 161  // (mm) Y point for Z homing
#endif
...
#define DIAG_JUMPERS_REMOVED // define when SENSORLESS_HOMING is disabled.